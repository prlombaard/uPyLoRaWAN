...
__DEBUG__ = True
__LORAWAN__ = True  #True if using loraWAN
...
class SX127x:
    ...
    def send_data(self, data, data_length, frame_counter, timeout=5):
        ...
        if __DEBUG__:
            print("PHYPayload with FRMPayload      ", lora_pkt)
